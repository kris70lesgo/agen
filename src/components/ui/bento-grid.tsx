...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "transform-gpu hover:border-purple-500/40 hover:from-purple-900/30 hover:to-blue-900/30",
      "transition-all duration-300 ease-out [box-shadow:0_0_20px_rgba(168,85,247,0.1)]",
      className
    )}
    {...props}
  >
    ...
    <div className="p-4">
      ...
      >
        <Button
          ...
          asChild
          size="sm"
          className="pointer-events-auto p-0 text-purple-400 hover:text-cyan-400"
        >
          <a href={href}>
            {cta}
